                    ...
                    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden relative">
                            ...
                            <form id="formCariTiket">
                                ...
                                <div class="flex shadow-sm rounded-xl overflow-hidden">
                                    <input type="text" id="kode_input" name="kode_input"
                                           class="w-full px-6 py-4 border-2 border-gray-200 border-r-0 rounded-l-xl text-2xl font-bold text-gray-800 focus:ring-0 focus:border-primary placeholder-gray-300 uppercase transition"
                                           placeholder="SCAN DISINI..." required autocomplete="off">
                                    <button type="submit" id="btnCari" class="px-8 py-4 bg-primary text-white font-bold hover:bg-blue-900 transition duration-200 border-2 border-primary">
                        ...
                        <div id="paymentDetails" class="p-8 hidden">
                            <div class="flex items-center justify-between mb-6">
                                ...
                                <div class="px-3 py-1 rounded bg-blue-50 text-blue-700 text-xs font-bold uppercase tracking-wider">
                                    Transaksi Keluar
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
                                <div class="p-4 bg-gray-50 rounded-xl border border-gray-100">
                                    ...
                                    <p id="detail_plat" class="text-xl font-extrabold text-primary mt-1">-</p>
                                </div>
                                <div class="p-4 bg-gray-50 rounded-xl border border-gray-100">
                            ...
                            <form id="formPembayaran">
                                ...
                                <div class="bg-primary rounded-2xl p-6 text-white shadow-lg mb-6 relative overflow-hidden">
                                    <div class="absolute top-0 right-0 -mt-4 -mr-4 w-24 h-24 bg-white opacity-10 rounded-full blur-2xl"></div>
                                    <div class="flex justify-between items-end relative z-10">
                                        <div>
                                            <span class="block text-blue-200 text-sm font-medium mb-1">Total Tagihan</span>
                                            <span id="detail_biaya" class="text-5xl font-extrabold text-accent tracking-tight">Rp 0</span>
                                        </div>
                                        <i class="fas fa-wallet text-4xl text-blue-400 opacity-50"></i>
                                    </div>
                                </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="number" id="jumlah_bayar" name="jumlah_bayar"
                                                   class="w-full pl-12 pr-4 py-3 border-2 border-gray-300 rounded-xl text-xl font-bold focus:ring-2 focus:ring-accent focus:border-accent transition outline-none" 
                                ...
                                <div class="flex gap-4">
                                    ...
                                    <button type="submit" id="btnProses" class="w-2/3 px-6 py-4 bg-success text-white rounded-xl font-bold hover:bg-emerald-600 text-lg shadow-lg hover:shadow-xl transition duration-200 flex items-center justify-center transform hover:-translate-y-0.5">
                        ...
                        <div class="p-4 bg-gray-50 border-t border-gray-100 flex justify-between items-center">
                            <div class="text-xs text-gray-400 font-medium">
                                <i class="fas fa-info-circle mr-1"></i> Tekan F5 untuk refresh jika sistem macet.
                            </div>
                            ...
                            <div class="space-y-3">
                                <div class="flex items-center justify-between p-3 bg-green-50 rounded-xl border border-green-100">
                                    <div class="flex items-center">
                                        <span class="w-2.5 h-2.5 bg-success rounded-full mr-3 animate-pulse"></span>
                                ...
                                <div class="flex items-center justify-between p-3 bg-green-50 rounded-xl border border-green-100">
                                    ...
                                    <span class="text-xs font-bold text-success">READY</span>
                                </div>
                            </div>
                        </div>
                    </div>
